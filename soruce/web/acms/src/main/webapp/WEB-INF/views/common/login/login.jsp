...
<html lang="en">
    ...
    <body class="login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="/common/login/loginAction" method="post">
                <h3 class="form-title">acms 로그인</h3>
                <div class="alert alert-danger display-hide">
                    <button class="close" data-close="alert"></button>
                    <span> 이이디/비밀번호를 입력해주세요. </span>
                </div>
                ...
                <div class="forget-password">
                    <p> 비밀번호를 잊어버리셨나요?
                        <a href="javascript:;" id="forget-password">   비밀번호 초기화. </a></p>
                </div>
                <div class="create-account">
                    <p> 계정이 없으신가요 ?&nbsp;
                        <a href="javascript:;" id="register-btn"> 신규 계정 생성 </a>
                    </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
